...
depth.curve.Tukey <- function(objects, data, nDirs = 100L, subs = TRUE, fracInt = 0.5, fracEst = 0.5, parConst1 = 0, parConst2 = 1, parMode = -1L, subsamples = NULL, exactEst = TRUE, minMassObj = 0, minMassDat = 0) {
    .Call('_curveDepth_depthCurveTukey', PACKAGE = 'curveDepth', objects, data, nDirs, subs, fracInt, fracEst, parConst1, parConst2, parMode, subsamples, exactEst, minMassObj, minMassDat)
}
...
sample.sets <- function(sets, ptsPerSet = as.integer( c(500)), randomPoints = TRUE) {
    .Call('_curveDepth_setsSubsample', PACKAGE = 'curveDepth', sets, ptsPerSet, randomPoints)
}

sample.pointsSets <- function(sets, ptsPerSet = as.integer( c(500))) {
    .Call('_curveDepth_pointsSetsSubsample', PACKAGE = 'curveDepth', sets, ptsPerSet)
}

depths.Tukey <- function(objects, data, inputType = "points", nDirs = 100L, subs = TRUE, m = 500L, fracInt = 0.5, fracEst = 0.5, exactEst = TRUE, parConst1 = 0, parConst2 = 1, parMode = -1L, minMassObj = 0, minMassDat = 0, randObj = TRUE, randDat = TRUE) {
    .Call('_curveDepth_depthSTukey', PACKAGE = 'curveDepth', objects, data, inputType, nDirs, subs, m, fracInt, fracEst, exactEst, parConst1, parConst2, parMode, minMassObj, minMassDat, randObj, randDat)
}
